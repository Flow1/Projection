...
public class GeodeticCalculator {
	...
	public GlobalCoordinates calculateEndingGlobalCoordinates(
			Ellipsoid ellipsoid, GlobalCoordinates start, double startBearing,
	...
	public GeodeticMeasurement calculateGeodeticMeasurement(
			Ellipsoid refEllipsoid, GlobalPosition start, GlobalPosition end) {
		...
		GeodeticCurve averageCurve = calculateGeodeticCurve(ellipsoid, start,
				end);
