...
public class GeodeticMeasurement extends GeodeticCurve {
	 ...
	 */
	public GeodeticMeasurement(double ellipsoidalDistance, double azimuth,
		...
		mP2P = Math.sqrt(ellipsoidalDistance * ellipsoidalDistance
	...
	public GeodeticMeasurement(GeodeticCurve averageCurve,
		...
		this(averageCurve.getEllipsoidalDistance(), averageCurve.getAzimuth(),
				averageCurve.getReverseAzimuth(), elevationChange);
	}
